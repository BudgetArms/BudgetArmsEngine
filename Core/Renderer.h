...
namespace bae
{
	...
	public:
		...
		void RenderTexture(const Texture2D& texture, bool isCenteredAtPosition, const SDL_FRect& src, const SDL_FRect& dst, float angle = 0.f, const glm::vec2& scale = { 1.f, 1.f }) const;
